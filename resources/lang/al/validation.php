...
return [
    ...
    'required_without'               => 'Fusha :attribute është e domosdoshme kur :values nuk ësjhtë e plotësuar.',
    'required_without_all'           => 'Fusha :attribute është e domosdoshme kur asnjë nga :values nuk janë të plotësuara.',
    'same'                           => 'Fusha :attribute duhet të përputhet me :other.',
    'size'                           => [
        'numeric' => 'Fusha :attribute duhet të jetë :size.',
        'file'    => 'Fusha :attribute duhet të jetë :size kilobzte.',
        'string'  => 'Fusha :attribute duhet të ketë :size karaktere.',
        'array'   => 'Fusha :attribute duhet të përmbajë :size elemente.',
    ],
    'starts_with'                    => 'Fusha :attribute duhet të fillojë me: :values.',
    'string'                         => 'Fusha :attribute duhet të jetë text.',
    'timezone'                       => 'Fusha :attribute duhet të jetë e vlefshme.',
    'unique'                         => 'Vlera e fushës :attribute është e zënë.',
    'uploaded'                       => 'Ngarkimi i :attribute dështoi.',
    'url'                            => 'Fusha :attribute nuk është në formatin e duhur.',
    'uuid'                           => 'Fusha :attribute duhet të jetë në formatin UUID.',
    'custom'                         => [
        'attribute-name' => [
            'rule-name' => 'custom-message',
        ],
    ],
    'reserved_word'                  => 'Fusha :attribute përmban një fjalë të rezervuar.',
