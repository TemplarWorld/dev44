    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contractors.update", [$contractor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $contractor->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor_contact') ? 'is-invalid' : '' }}" type="text" name="contractor_contact" id="contractor_contact" value="{{ old('contractor_contact', $contractor->contractor_contact) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor_street_address') ? 'is-invalid' : '' }}" type="text" name="contractor_street_address" id="contractor_street_address" value="{{ old('contractor_street_address', $contractor->contractor_street_address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor_city') ? 'is-invalid' : '' }}" type="text" name="contractor_city" id="contractor_city" value="{{ old('contractor_city', $contractor->contractor_city) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor_state') ? 'is-invalid' : '' }}" type="text" name="contractor_state" id="contractor_state" value="{{ old('contractor_state', $contractor->contractor_state) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor_zip') ? 'is-invalid' : '' }}" type="text" name="contractor_zip" id="contractor_zip" value="{{ old('contractor_zip', $contractor->contractor_zip) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor_email') ? 'is-invalid' : '' }}" type="email" name="contractor_email" id="contractor_email" value="{{ old('contractor_email', $contractor->contractor_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor_247_tel') ? 'is-invalid' : '' }}" type="text" name="contractor_247_tel" id="contractor_247_tel" value="{{ old('contractor_247_tel', $contractor->contractor_247_tel) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor_tel') ? 'is-invalid' : '' }}" type="text" name="contractor_tel" id="contractor_tel" value="{{ old('contractor_tel', $contractor->contractor_tel) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contractor_tel_2') ? 'is-invalid' : '' }}" type="text" name="contractor_tel_2" id="contractor_tel_2" value="{{ old('contractor_tel_2', $contractor->contractor_tel_2) }}">
