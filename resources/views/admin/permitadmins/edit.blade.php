...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.permitadmin.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.permitadmins.update", [$permitadmin->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('submitted_by') ? 'is-invalid' : '' }}" name="submitted_by_id" id="submitted_by_id">
                    @foreach($submitted_bies as $id => $submitted_by)
                        <option value="{{ $id }}" {{ (old('submitted_by_id') ? old('submitted_by_id') : $permitadmin->submitted_by->id ?? '') == $id ? 'selected' : '' }}>{{ $submitted_by }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('permit_approval') ? 'is-invalid' : '' }}" name="permit_approval" id="permit_approval">
                    ...
                    @foreach(App\Permitadmin::PERMIT_APPROVAL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('permit_approval', $permitadmin->permit_approval) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('workorder_1') ? 'is-invalid' : '' }}" type="text" name="workorder_1" id="workorder_1" value="{{ old('workorder_1', $permitadmin->workorder_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('workorder_2') ? 'is-invalid' : '' }}" type="text" name="workorder_2" id="workorder_2" value="{{ old('workorder_2', $permitadmin->workorder_2) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('name') ? 'is-invalid' : '' }}" name="name_id" id="name_id">
                    @foreach($names as $id => $name)
                        <option value="{{ $id }}" {{ (old('name_id') ? old('name_id') : $permitadmin->name->id ?? '') == $id ? 'selected' : '' }}>{{ $name }}</option>
                    @endforeach
                </select>
                @if($errors->has('name'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_number') ? 'is-invalid' : '' }}" name="project_number_id" id="project_number_id">
                    @foreach($project_numbers as $id => $project_number)
                        <option value="{{ $id }}" {{ (old('project_number_id') ? old('project_number_id') : $permitadmin->project_number->id ?? '') == $id ? 'selected' : '' }}>{{ $project_number }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_manager') ? 'is-invalid' : '' }}" name="project_manager_id" id="project_manager_id">
                    @foreach($project_managers as $id => $project_manager)
                        <option value="{{ $id }}" {{ (old('project_manager_id') ? old('project_manager_id') : $permitadmin->project_manager->id ?? '') == $id ? 'selected' : '' }}>{{ $project_manager }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_coordinator') ? 'is-invalid' : '' }}" name="project_coordinator_id" id="project_coordinator_id">
                    @foreach($project_coordinators as $id => $project_coordinator)
                        <option value="{{ $id }}" {{ (old('project_coordinator_id') ? old('project_coordinator_id') : $permitadmin->project_coordinator->id ?? '') == $id ? 'selected' : '' }}>{{ $project_coordinator }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contractor_name') ? 'is-invalid' : '' }}" name="contractor_name_id" id="contractor_name_id">
                    @foreach($contractor_names as $id => $contractor_name)
                        <option value="{{ $id }}" {{ (old('contractor_name_id') ? old('contractor_name_id') : $permitadmin->contractor_name->id ?? '') == $id ? 'selected' : '' }}>{{ $contractor_name }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contractor_supervisor') ? 'is-invalid' : '' }}" name="contractor_supervisor_id" id="contractor_supervisor_id">
                    @foreach($contractor_supervisors as $id => $contractor_supervisor)
                        <option value="{{ $id }}" {{ (old('contractor_supervisor_id') ? old('contractor_supervisor_id') : $permitadmin->contractor_supervisor->id ?? '') == $id ? 'selected' : '' }}>{{ $contractor_supervisor }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('site_supervisor_tel') ? 'is-invalid' : '' }}" name="site_supervisor_tel_id" id="site_supervisor_tel_id">
                    @foreach($site_supervisor_tels as $id => $site_supervisor_tel)
                        <option value="{{ $id }}" {{ (old('site_supervisor_tel_id') ? old('site_supervisor_tel_id') : $permitadmin->site_supervisor_tel->id ?? '') == $id ? 'selected' : '' }}>{{ $site_supervisor_tel }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('site_supervisor_email') ? 'is-invalid' : '' }}" name="site_supervisor_email_id" id="site_supervisor_email_id">
                    @foreach($site_supervisor_emails as $id => $site_supervisor_email)
                        <option value="{{ $id }}" {{ (old('site_supervisor_email_id') ? old('site_supervisor_email_id') : $permitadmin->site_supervisor_email->id ?? '') == $id ? 'selected' : '' }}>{{ $site_supervisor_email }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_site') ? 'is-invalid' : '' }}" name="project_site_id" id="project_site_id">
                    @foreach($project_sites as $id => $project_site)
                        <option value="{{ $id }}" {{ (old('project_site_id') ? old('project_site_id') : $permitadmin->project_site->id ?? '') == $id ? 'selected' : '' }}>{{ $project_site }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_building') ? 'is-invalid' : '' }}" name="project_building_id" id="project_building_id">
                    @foreach($project_buildings as $id => $project_building)
                        <option value="{{ $id }}" {{ (old('project_building_id') ? old('project_building_id') : $permitadmin->project_building->id ?? '') == $id ? 'selected' : '' }}>{{ $project_building }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_area') ? 'is-invalid' : '' }}" name="project_area_id" id="project_area_id">
                    @foreach($project_areas as $id => $project_area)
                        <option value="{{ $id }}" {{ (old('project_area_id') ? old('project_area_id') : $permitadmin->project_area->id ?? '') == $id ? 'selected' : '' }}>{{ $project_area }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('work_type') ? 'is-invalid' : '' }}" name="work_type_id" id="work_type_id">
                    @foreach($work_types as $id => $work_type)
                        <option value="{{ $id }}" {{ (old('work_type_id') ? old('work_type_id') : $permitadmin->work_type->id ?? '') == $id ? 'selected' : '' }}>{{ $work_type }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('permit_description') ? 'is-invalid' : '' }}" name="permit_description" id="permit_description">{{ old('permit_description', $permitadmin->permit_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $permitadmin->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $permitadmin->end_date) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('system_isolation_1') ? 'is-invalid' : '' }}" name="system_isolation_1" id="system_isolation_1">
                    ...
                    @foreach(App\Permitadmin::SYSTEM_ISOLATION_1_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('system_isolation_1', $permitadmin->system_isolation_1) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('start_date_iso_1') ? 'is-invalid' : '' }}" type="text" name="start_date_iso_1" id="start_date_iso_1" value="{{ old('start_date_iso_1', $permitadmin->start_date_iso_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('end_date_iso_1') ? 'is-invalid' : '' }}" type="text" name="end_date_iso_1" id="end_date_iso_1" value="{{ old('end_date_iso_1', $permitadmin->end_date_iso_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('start_time_iso_1') ? 'is-invalid' : '' }}" type="text" name="start_time_iso_1" id="start_time_iso_1" value="{{ old('start_time_iso_1', $permitadmin->start_time_iso_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('end_time_iso_1') ? 'is-invalid' : '' }}" type="text" name="end_time_iso_1" id="end_time_iso_1" value="{{ old('end_time_iso_1', $permitadmin->end_time_iso_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('system_iso_1_description') ? 'is-invalid' : '' }}" type="text" name="system_iso_1_description" id="system_iso_1_description" value="{{ old('system_iso_1_description', $permitadmin->system_iso_1_description) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('iso_1_contractor') ? 'is-invalid' : '' }}" name="iso_1_contractor_id" id="iso_1_contractor_id">
                    @foreach($iso_1_contractors as $id => $iso_1_contractor)
                        <option value="{{ $id }}" {{ (old('iso_1_contractor_id') ? old('iso_1_contractor_id') : $permitadmin->iso_1_contractor->id ?? '') == $id ? 'selected' : '' }}>{{ $iso_1_contractor }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('iso_contractor_supervisor') ? 'is-invalid' : '' }}" name="iso_contractor_supervisor_id" id="iso_contractor_supervisor_id">
                    @foreach($iso_contractor_supervisors as $id => $iso_contractor_supervisor)
                        <option value="{{ $id }}" {{ (old('iso_contractor_supervisor_id') ? old('iso_contractor_supervisor_id') : $permitadmin->iso_contractor_supervisor->id ?? '') == $id ? 'selected' : '' }}>{{ $iso_contractor_supervisor }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('iso_supervisor_tel') ? 'is-invalid' : '' }}" name="iso_supervisor_tel_id" id="iso_supervisor_tel_id">
                    @foreach($iso_supervisor_tels as $id => $iso_supervisor_tel)
                        <option value="{{ $id }}" {{ (old('iso_supervisor_tel_id') ? old('iso_supervisor_tel_id') : $permitadmin->iso_supervisor_tel->id ?? '') == $id ? 'selected' : '' }}>{{ $iso_supervisor_tel }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('iso_supervisor_email') ? 'is-invalid' : '' }}" name="iso_supervisor_email_id" id="iso_supervisor_email_id">
                    @foreach($iso_supervisor_emails as $id => $iso_supervisor_email)
                        <option value="{{ $id }}" {{ (old('iso_supervisor_email_id') ? old('iso_supervisor_email_id') : $permitadmin->iso_supervisor_email->id ?? '') == $id ? 'selected' : '' }}>{{ $iso_supervisor_email }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('related_permit') ? 'is-invalid' : '' }}" type="text" name="related_permit" id="related_permit" value="{{ old('related_permit', $permitadmin->related_permit) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hot_work_req') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hot_work_req" id="hot_work_req" value="1" {{ $permitadmin->hot_work_req || old('hot_work_req', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('icra_req') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="icra_req" id="icra_req" value="1" {{ $permitadmin->icra_req || old('icra_req', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hoarding_req') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hoarding_req" id="hoarding_req" value="1" {{ $permitadmin->hoarding_req || old('hoarding_req', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('area_hazard') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="area_hazard" id="area_hazard" value="1" {{ $permitadmin->area_hazard || old('area_hazard', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('welding_brazing_silfoss') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="welding_brazing_silfoss" id="welding_brazing_silfoss" value="1" {{ $permitadmin->welding_brazing_silfoss || old('welding_brazing_silfoss', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_of_abatement') ? 'is-invalid' : '' }}" type="text" name="type_of_abatement" id="type_of_abatement" value="{{ old('type_of_abatement', $permitadmin->type_of_abatement) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('jha_swp') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="jha_swp" id="jha_swp" value="1" {{ $permitadmin->jha_swp || old('jha_swp', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('fall_protection_plan') ? 'is-invalid' : '' }}" name="fall_protection_plan" id="fall_protection_plan">
                    ...
                    @foreach(App\Permitadmin::FALL_PROTECTION_PLAN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('fall_protection_plan', $permitadmin->fall_protection_plan) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('confined_space_entry_plan') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="confined_space_entry_plan" id="confined_space_entry_plan" value="1" {{ $permitadmin->confined_space_entry_plan || old('confined_space_entry_plan', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('mold_removal_plan') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="mold_removal_plan" id="mold_removal_plan" value="1" {{ $permitadmin->mold_removal_plan || old('mold_removal_plan', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('site_conditions') ? 'is-invalid' : '' }}" name="site_conditions" id="site_conditions">{{ old('site_conditions', $permitadmin->site_conditions) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('additional_information') ? 'is-invalid' : '' }}" name="additional_information" id="additional_information">{{ old('additional_information', $permitadmin->additional_information) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('permit_approved_by') ? 'is-invalid' : '' }}" name="permit_approved_by_id" id="permit_approved_by_id">
                    @foreach($permit_approved_bies as $id => $permit_approved_by)
                        <option value="{{ $id }}" {{ (old('permit_approved_by_id') ? old('permit_approved_by_id') : $permitadmin->permit_approved_by->id ?? '') == $id ? 'selected' : '' }}>{{ $permit_approved_by }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('permit_approval_date') ? 'is-invalid' : '' }}" type="text" name="permit_approval_date" id="permit_approval_date" value="{{ old('permit_approval_date', $permitadmin->permit_approval_date) }}">
