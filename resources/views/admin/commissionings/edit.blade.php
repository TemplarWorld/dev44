...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.commissioning.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.commissionings.update", [$commissioning->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="comm_1_worko">{{ trans('cruds.commissioning.fields.comm_1_worko') }}</label>
                <input class="form-control {{ $errors->has('comm_1_worko') ? 'is-invalid' : '' }}" type="text" name="comm_1_worko" id="comm_1_worko" value="{{ old('comm_1_worko', $commissioning->comm_1_worko) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_name') ? 'is-invalid' : '' }}" name="project_name_id" id="project_name_id">
                    @foreach($project_names as $id => $project_name)
                        <option value="{{ $id }}" {{ (old('project_name_id') ? old('project_name_id') : $commissioning->project_name->id ?? '') == $id ? 'selected' : '' }}>{{ $project_name }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_manager') ? 'is-invalid' : '' }}" name="project_manager_id" id="project_manager_id" required>
                    @foreach($project_managers as $id => $project_manager)
                        <option value="{{ $id }}" {{ (old('project_manager_id') ? old('project_manager_id') : $commissioning->project_manager->id ?? '') == $id ? 'selected' : '' }}>{{ $project_manager }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_coordinator') ? 'is-invalid' : '' }}" name="project_coordinator_id" id="project_coordinator_id">
                    @foreach($project_coordinators as $id => $project_coordinator)
                        <option value="{{ $id }}" {{ (old('project_coordinator_id') ? old('project_coordinator_id') : $commissioning->project_coordinator->id ?? '') == $id ? 'selected' : '' }}>{{ $project_coordinator }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_number') ? 'is-invalid' : '' }}" name="project_number_id" id="project_number_id">
                    @foreach($project_numbers as $id => $project_number)
                        <option value="{{ $id }}" {{ (old('project_number_id') ? old('project_number_id') : $commissioning->project_number->id ?? '') == $id ? 'selected' : '' }}>{{ $project_number }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comm_system_1') ? 'is-invalid' : '' }}" type="text" name="comm_system_1" id="comm_system_1" value="{{ old('comm_system_1', $commissioning->comm_system_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comm_location_1') ? 'is-invalid' : '' }}" type="text" name="comm_location_1" id="comm_location_1" value="{{ old('comm_location_1', $commissioning->comm_location_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comm_description_1') ? 'is-invalid' : '' }}" type="text" name="comm_description_1" id="comm_description_1" value="{{ old('comm_description_1', $commissioning->comm_description_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('comm_datestart_1') ? 'is-invalid' : '' }}" type="text" name="comm_datestart_1" id="comm_datestart_1" value="{{ old('comm_datestart_1', $commissioning->comm_datestart_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('comm_enddate_1') ? 'is-invalid' : '' }}" type="text" name="comm_enddate_1" id="comm_enddate_1" value="{{ old('comm_enddate_1', $commissioning->comm_enddate_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('comm_starttime_1') ? 'is-invalid' : '' }}" type="text" name="comm_starttime_1" id="comm_starttime_1" value="{{ old('comm_starttime_1', $commissioning->comm_starttime_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('comm_endtime') ? 'is-invalid' : '' }}" type="text" name="comm_endtime" id="comm_endtime" value="{{ old('comm_endtime', $commissioning->comm_endtime) }}">
