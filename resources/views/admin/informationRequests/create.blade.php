...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.informationRequest.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.information-requests.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="requested_by">{{ trans('cruds.informationRequest.fields.requested_by') }}</label>
                <input class="form-control {{ $errors->has('requested_by') ? 'is-invalid' : '' }}" type="text" name="requested_by" id="requested_by" value="{{ old('requested_by', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('info_tel') ? 'is-invalid' : '' }}" type="text" name="info_tel" id="info_tel" value="{{ old('info_tel', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('req_email') ? 'is-invalid' : '' }}" type="email" name="req_email" id="req_email" value="{{ old('req_email') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('info_date_req') ? 'is-invalid' : '' }}" type="text" name="info_date_req" id="info_date_req" value="{{ old('info_date_req') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('info_descrip') ? 'is-invalid' : '' }}" name="info_descrip" id="info_descrip" required>{{ old('info_descrip') }}</textarea>
