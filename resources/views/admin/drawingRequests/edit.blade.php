...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.drawingRequest.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.drawing-requests.update", [$drawingRequest->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="tracking_number">{{ trans('cruds.drawingRequest.fields.tracking_number') }}</label>
                <input class="form-control {{ $errors->has('tracking_number') ? 'is-invalid' : '' }}" type="text" name="tracking_number" id="tracking_number" value="{{ old('tracking_number', $drawingRequest->tracking_number) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('dr_approval') ? 'is-invalid' : '' }}" name="dr_approval_id" id="dr_approval_id">
                    @foreach($dr_approvals as $id => $dr_approval)
                        <option value="{{ $id }}" {{ (old('dr_approval_id') ? old('dr_approval_id') : $drawingRequest->dr_approval->id ?? '') == $id ? 'selected' : '' }}>{{ $dr_approval }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dr_requested_by') ? 'is-invalid' : '' }}" type="text" name="dr_requested_by" id="dr_requested_by" value="{{ old('dr_requested_by', $drawingRequest->dr_requested_by) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_required') ? 'is-invalid' : '' }}" type="text" name="date_required" id="date_required" value="{{ old('date_required', $drawingRequest->date_required) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_name') ? 'is-invalid' : '' }}" name="project_name_id" id="project_name_id">
                    @foreach($project_names as $id => $project_name)
                        <option value="{{ $id }}" {{ (old('project_name_id') ? old('project_name_id') : $drawingRequest->project_name->id ?? '') == $id ? 'selected' : '' }}>{{ $project_name }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_manager') ? 'is-invalid' : '' }}" name="project_manager_id" id="project_manager_id">
                    @foreach($project_managers as $id => $project_manager)
                        <option value="{{ $id }}" {{ (old('project_manager_id') ? old('project_manager_id') : $drawingRequest->project_manager->id ?? '') == $id ? 'selected' : '' }}>{{ $project_manager }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_coordinator') ? 'is-invalid' : '' }}" name="project_coordinator_id" id="project_coordinator_id">
                    @foreach($project_coordinators as $id => $project_coordinator)
                        <option value="{{ $id }}" {{ (old('project_coordinator_id') ? old('project_coordinator_id') : $drawingRequest->project_coordinator->id ?? '') == $id ? 'selected' : '' }}>{{ $project_coordinator }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('project_description') ? 'is-invalid' : '' }}" name="project_description" id="project_description" required>{{ old('project_description', $drawingRequest->project_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_group') ? 'is-invalid' : '' }}" name="project_group_id" id="project_group_id">
                    @foreach($project_groups as $id => $project_group)
                        <option value="{{ $id }}" {{ (old('project_group_id') ? old('project_group_id') : $drawingRequest->project_group->id ?? '') == $id ? 'selected' : '' }}>{{ $project_group }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_building') ? 'is-invalid' : '' }}" name="project_building_id" id="project_building_id" required>
                    @foreach($project_buildings as $id => $project_building)
                        <option value="{{ $id }}" {{ (old('project_building_id') ? old('project_building_id') : $drawingRequest->project_building->id ?? '') == $id ? 'selected' : '' }}>{{ $project_building }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_area') ? 'is-invalid' : '' }}" name="project_area_id" id="project_area_id">
                    @foreach($project_areas as $id => $project_area)
                        <option value="{{ $id }}" {{ (old('project_area_id') ? old('project_area_id') : $drawingRequest->project_area->id ?? '') == $id ? 'selected' : '' }}>{{ $project_area }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('dr_1_discipline') ? 'is-invalid' : '' }}" name="dr_1_discipline" id="dr_1_discipline">
                    ...
                    @foreach(App\DrawingRequest::DR_1_DISCIPLINE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('dr_1_discipline', $drawingRequest->dr_1_discipline) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('dr_1_type') ? 'is-invalid' : '' }}" name="dr_1_type" id="dr_1_type">
                    ...
                    @foreach(App\DrawingRequest::DR_1_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('dr_1_type', $drawingRequest->dr_1_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dr_1_type_description') ? 'is-invalid' : '' }}" type="text" name="dr_1_type_description" id="dr_1_type_description" value="{{ old('dr_1_type_description', $drawingRequest->dr_1_type_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_building_2') ? 'is-invalid' : '' }}" type="text" name="project_building_2" id="project_building_2" value="{{ old('project_building_2', $drawingRequest->project_building_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_area_2') ? 'is-invalid' : '' }}" type="text" name="project_area_2" id="project_area_2" value="{{ old('project_area_2', $drawingRequest->project_area_2) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('dr_2_discipline') ? 'is-invalid' : '' }}" name="dr_2_discipline" id="dr_2_discipline">
                    ...
                    @foreach(App\DrawingRequest::DR_2_DISCIPLINE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('dr_2_discipline', $drawingRequest->dr_2_discipline) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('dr_2_type') ? 'is-invalid' : '' }}" name="dr_2_type" id="dr_2_type">
                    ...
                    @foreach(App\DrawingRequest::DR_2_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('dr_2_type', $drawingRequest->dr_2_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dr_2_type_description') ? 'is-invalid' : '' }}" type="text" name="dr_2_type_description" id="dr_2_type_description" value="{{ old('dr_2_type_description', $drawingRequest->dr_2_type_description) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_building_3') ? 'is-invalid' : '' }}" type="text" name="project_building_3" id="project_building_3" value="{{ old('project_building_3', $drawingRequest->project_building_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_area_3') ? 'is-invalid' : '' }}" type="text" name="project_area_3" id="project_area_3" value="{{ old('project_area_3', $drawingRequest->project_area_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dr_3_type') ? 'is-invalid' : '' }}" type="text" name="dr_3_type" id="dr_3_type" value="{{ old('dr_3_type', $drawingRequest->dr_3_type) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('dr_1_civil') ? 'is-invalid' : '' }}" name="dr_1_civil" id="dr_1_civil">
                    ...
                    @foreach(App\DrawingRequest::DR_1_CIVIL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('dr_1_civil', $drawingRequest->dr_1_civil) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('dr_2_civil') ? 'is-invalid' : '' }}" name="dr_2_civil" id="dr_2_civil">
                    ...
                    @foreach(App\DrawingRequest::DR_2_CIVIL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('dr_2_civil', $drawingRequest->dr_2_civil) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('civil_other') ? 'is-invalid' : '' }}" type="text" name="civil_other" id="civil_other" value="{{ old('civil_other', $drawingRequest->civil_other) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('civil_descrip') ? 'is-invalid' : '' }}" type="text" name="civil_descrip" id="civil_descrip" value="{{ old('civil_descrip', $drawingRequest->civil_descrip) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('drawing_number_title') ? 'is-invalid' : '' }}" name="drawing_number_title" id="drawing_number_title">{{ old('drawing_number_title', $drawingRequest->drawing_number_title) }}</textarea>
