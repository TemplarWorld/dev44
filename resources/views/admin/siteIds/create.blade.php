...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.siteId.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.site-ids.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_address_1') ? 'is-invalid' : '' }}" type="text" name="site_address_1" id="site_address_1" value="{{ old('site_address_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_address_2') ? 'is-invalid' : '' }}" type="text" name="site_address_2" id="site_address_2" value="{{ old('site_address_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_city') ? 'is-invalid' : '' }}" type="text" name="site_city" id="site_city" value="{{ old('site_city', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_state') ? 'is-invalid' : '' }}" type="text" name="site_state" id="site_state" value="{{ old('site_state', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_country') ? 'is-invalid' : '' }}" type="text" name="site_country" id="site_country" value="{{ old('site_country', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_telephone') ? 'is-invalid' : '' }}" type="text" name="site_telephone" id="site_telephone" value="{{ old('site_telephone', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site_email') ? 'is-invalid' : '' }}" type="text" name="site_email" id="site_email" value="{{ old('site_email', '') }}">
