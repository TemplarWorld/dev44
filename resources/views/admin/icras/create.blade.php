...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.icra.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.icras.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_description') ? 'is-invalid' : '' }}" name="project_description_id" id="project_description_id">
                    @foreach($project_descriptions as $id => $project_description)
                        <option value="{{ $id }}" {{ old('project_description_id') == $id ? 'selected' : '' }}>{{ $project_description }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('icra_program') ? 'is-invalid' : '' }}" type="text" name="icra_program" id="icra_program" value="{{ old('icra_program', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('type_a') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="type_a" id="type_a" value="1" {{ old('type_a', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('type_b') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="type_b" id="type_b" value="1" {{ old('type_b', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('type_c') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="type_c" id="type_c" value="1" {{ old('type_c', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('type_d') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="type_d" id="type_d" value="1" {{ old('type_d', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('group_1') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="group_1" id="group_1" value="1" {{ old('group_1', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('group_2') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="group_2" id="group_2" value="1" {{ old('group_2', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('group_3') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="group_3" id="group_3" value="1" {{ old('group_3', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('group_4') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="group_4" id="group_4" value="1" {{ old('group_4', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('icra_pmd') ? 'is-invalid' : '' }}" name="icra_pmd" id="icra_pmd">
                    ...
                    @foreach(App\Icra::ICRA_PMD_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('icra_pmd', '- select -') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('icra_areas_impact_side_a') ? 'is-invalid' : '' }}" name="icra_areas_impact_side_a" id="icra_areas_impact_side_a">
                    ...
                    @foreach(App\Icra::ICRA_AREAS_IMPACT_SIDE_A_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('icra_areas_impact_side_a', '- select -') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('icra_areas_impact_side_b') ? 'is-invalid' : '' }}" name="icra_areas_impact_side_b" id="icra_areas_impact_side_b">
                    ...
                    @foreach(App\Icra::ICRA_AREAS_IMPACT_SIDE_B_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('icra_areas_impact_side_b', '- select -') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('icra_areas_impact_side_c') ? 'is-invalid' : '' }}" name="icra_areas_impact_side_c" id="icra_areas_impact_side_c">
                    ...
                    @foreach(App\Icra::ICRA_AREAS_IMPACT_SIDE_C_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('icra_areas_impact_side_c', '- select -') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('icra_areas_impact_side_d') ? 'is-invalid' : '' }}" name="icra_areas_impact_side_d" id="icra_areas_impact_side_d">
                    ...
                    @foreach(App\Icra::ICRA_AREAS_IMPACT_SIDE_D_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('icra_areas_impact_side_d', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('icra_notes') ? 'is-invalid' : '' }}" name="icra_notes" id="icra_notes">{{ old('icra_notes') }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('icra_hoarding_type') ? 'is-invalid' : '' }}" name="icra_hoarding_type" id="icra_hoarding_type">
                    ...
                    @foreach(App\Icra::ICRA_HOARDING_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('icra_hoarding_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('icra_ante_pressure') ? 'is-invalid' : '' }}" type="text" name="icra_ante_pressure" id="icra_ante_pressure" value="{{ old('icra_ante_pressure', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('icra_const_area_pressure') ? 'is-invalid' : '' }}" type="text" name="icra_const_area_pressure" id="icra_const_area_pressure" value="{{ old('icra_const_area_pressure', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('icra_hepa_unit') ? 'is-invalid' : '' }}" name="icra_hepa_unit" id="icra_hepa_unit">
                    ...
                    @foreach(App\Icra::ICRA_HEPA_UNIT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('icra_hepa_unit', '- select -') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('icra_exhaust') ? 'is-invalid' : '' }}" name="icra_exhaust" id="icra_exhaust">
                    ...
                    @foreach(App\Icra::ICRA_EXHAUST_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('icra_exhaust', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('icra_pressure_mon') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="icra_pressure_mon" id="icra_pressure_mon" value="1" {{ old('icra_pressure_mon', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('icra_additional') ? 'is-invalid' : '' }}" name="icra_additional" id="icra_additional">{{ old('icra_additional') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('icra_requested_by') ? 'is-invalid' : '' }}" type="text" name="icra_requested_by" id="icra_requested_by" value="{{ old('icra_requested_by', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('icra_approved_by_1') ? 'is-invalid' : '' }}" name="icra_approved_by_1_id" id="icra_approved_by_1_id">
                    @foreach($icra_approved_by_1s as $id => $icra_approved_by_1)
                        <option value="{{ $id }}" {{ old('icra_approved_by_1_id') == $id ? 'selected' : '' }}>{{ $icra_approved_by_1 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('icra_approved_by_2') ? 'is-invalid' : '' }}" name="icra_approved_by_2_id" id="icra_approved_by_2_id">
                    @foreach($icra_approved_by_2s as $id => $icra_approved_by_2)
                        <option value="{{ $id }}" {{ old('icra_approved_by_2_id') == $id ? 'selected' : '' }}>{{ $icra_approved_by_2 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('icra_approved_by_3') ? 'is-invalid' : '' }}" name="icra_approved_by_3_id" id="icra_approved_by_3_id">
                    @foreach($icra_approved_by_3s as $id => $icra_approved_by_3)
                        <option value="{{ $id }}" {{ old('icra_approved_by_3_id') == $id ? 'selected' : '' }}>{{ $icra_approved_by_3 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('icra_approved_by_4') ? 'is-invalid' : '' }}" name="icra_approved_by_4_id" id="icra_approved_by_4_id">
                    @foreach($icra_approved_by_4s as $id => $icra_approved_by_4)
                        <option value="{{ $id }}" {{ old('icra_approved_by_4_id') == $id ? 'selected' : '' }}>{{ $icra_approved_by_4 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('icra_approval_date') ? 'is-invalid' : '' }}" type="text" name="icra_approval_date" id="icra_approval_date" value="{{ old('icra_approval_date') }}" required>
