    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.time-projects.update", [$timeProject->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $timeProject->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_number') ? 'is-invalid' : '' }}" type="text" name="account_number" id="account_number" value="{{ old('account_number', $timeProject->account_number) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('roles') ? 'is-invalid' : '' }}" name="roles_id" id="roles_id">
                    @foreach($roles as $id => $roles)
                        <option value="{{ $id }}" {{ (old('roles_id') ? old('roles_id') : $timeProject->roles->id ?? '') == $id ? 'selected' : '' }}>{{ $roles }}</option>
                    @endforeach
                </select>
                @if($errors->has('roles'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('project_coordinator') ? 'is-invalid' : '' }}" name="project_coordinator_id" id="project_coordinator_id">
                    @foreach($project_coordinators as $id => $project_coordinator)
                        <option value="{{ $id }}" {{ (old('project_coordinator_id') ? old('project_coordinator_id') : $timeProject->project_coordinator->id ?? '') == $id ? 'selected' : '' }}>{{ $project_coordinator }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_number') ? 'is-invalid' : '' }}" type="text" name="project_number" id="project_number" value="{{ old('project_number', $timeProject->project_number) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('project_group') ? 'is-invalid' : '' }}" name="project_group" id="project_group" required>
                    ...
                    @foreach(App\TimeProject::PROJECT_GROUP_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('project_group', $timeProject->project_group) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contractor_name') ? 'is-invalid' : '' }}" name="contractor_name_id" id="contractor_name_id">
                    @foreach($contractor_names as $id => $contractor_name)
                        <option value="{{ $id }}" {{ (old('contractor_name_id') ? old('contractor_name_id') : $timeProject->contractor_name->id ?? '') == $id ? 'selected' : '' }}>{{ $contractor_name }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contractor_supervisor') ? 'is-invalid' : '' }}" name="contractor_supervisor_id" id="contractor_supervisor_id">
                    @foreach($contractor_supervisors as $id => $contractor_supervisor)
                        <option value="{{ $id }}" {{ (old('contractor_supervisor_id') ? old('contractor_supervisor_id') : $timeProject->contractor_supervisor->id ?? '') == $id ? 'selected' : '' }}>{{ $contractor_supervisor }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('site_supervisor_tel') ? 'is-invalid' : '' }}" name="site_supervisor_tel_id" id="site_supervisor_tel_id">
                    @foreach($site_supervisor_tels as $id => $site_supervisor_tel)
                        <option value="{{ $id }}" {{ (old('site_supervisor_tel_id') ? old('site_supervisor_tel_id') : $timeProject->site_supervisor_tel->id ?? '') == $id ? 'selected' : '' }}>{{ $site_supervisor_tel }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('site_supervisor_email') ? 'is-invalid' : '' }}" name="site_supervisor_email_id" id="site_supervisor_email_id">
                    @foreach($site_supervisor_emails as $id => $site_supervisor_email)
                        <option value="{{ $id }}" {{ (old('site_supervisor_email_id') ? old('site_supervisor_email_id') : $timeProject->site_supervisor_email->id ?? '') == $id ? 'selected' : '' }}>{{ $site_supervisor_email }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('sub_contractors') ? 'is-invalid' : '' }}" name="sub_contractors[]" id="sub_contractors" multiple>
                    @foreach($sub_contractors as $id => $sub_contractors)
                        <option value="{{ $id }}" {{ (in_array($id, old('sub_contractors', [])) || $timeProject->sub_contractors->contains($id)) ? 'selected' : '' }}>{{ $sub_contractors }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('site') ? 'is-invalid' : '' }}" type="text" name="site" id="site" value="{{ old('site', $timeProject->site) }}">
                @if($errors->has('site'))
                    <div class="invalid-feedback">
                        {{ $errors->first('site') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_building') ? 'is-invalid' : '' }}" type="text" name="project_building" id="project_building" value="{{ old('project_building', $timeProject->project_building) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('project_area') ? 'is-invalid' : '' }}" type="text" name="project_area" id="project_area" value="{{ old('project_area', $timeProject->project_area) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('work_type') ? 'is-invalid' : '' }}" name="work_type_id" id="work_type_id">
                    @foreach($work_types as $id => $work_type)
                        <option value="{{ $id }}" {{ (old('work_type_id') ? old('work_type_id') : $timeProject->work_type->id ?? '') == $id ? 'selected' : '' }}>{{ $work_type }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('project_description') ? 'is-invalid' : '' }}" name="project_description" id="project_description" required>{{ old('project_description', $timeProject->project_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_date') ? 'is-invalid' : '' }}" type="text" name="start_date" id="start_date" value="{{ old('start_date', $timeProject->start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_date') ? 'is-invalid' : '' }}" type="text" name="end_date" id="end_date" value="{{ old('end_date', $timeProject->end_date) }}" required>
