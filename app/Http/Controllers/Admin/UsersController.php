...
class UsersController extends Controller
{
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'team', 'teamTimeProjects', 'rolesTimeProjects', 'projectCoordinatorTimeProjects', 'projectManagerPermitadmins', 'projectCoordinatorPermitadmins', 'submittedByPermitadmins', 'projectManagerDrawingRequests', 'projectCoordinatorDrawingRequests', 'userUserAlerts');
